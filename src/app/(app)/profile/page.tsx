...
export default function ProfilePage() {
  ...
  const userProfileDisplay = {
    name: currentUser?.fullName || firebaseUser?.user_metadata?.full_name || 'User Name',
    email: currentUser?.email || firebaseUser?.email || 'user@example.com',
    role: currentUser?.role || 'N/A',
    program: currentUser?.role === 'Student' ? 'Paramedic Program' : currentUser?.role || 'N/A',
          ...
          <form onSubmit={handleSubmit(onPasswordChangeSubmit)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <Input id="currentPassword" type="password" {...register('currentPassword')} className={errors.currentPassword ? 'border-destructive' : ''} />
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <Input id="confirmNewPassword" type="password" {...register('confirmNewPassword')} className={errors.confirmNewPassword ? 'border-destructive' : ''} />
